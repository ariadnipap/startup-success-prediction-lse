...
![Confusion Matrix for lr](..\docs\logreg_confusion_matrix.png)

For Random Forest:
![Confusion Matrix for rf](..\docs\rf_confusion_matrix.png)
...
### Random Forest
![Top-15-features-rf](..\docs\model_comparison.png)
